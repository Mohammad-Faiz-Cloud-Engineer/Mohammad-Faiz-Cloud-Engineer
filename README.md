...
I build reliable infrastructure, optimize performance, and ship systems that are secure, observable, and cost-efficient.
...
- Building secure backend systems with monitoring, logging, and alerting  
- Exploring cloud security, reliability engineering, and distributed systems  
- Creating developer-focused tools and platforms with real-world impact  
...
High-performance backend services designed for reliability, fault tolerance, and horizontal scaling.

### 🔹 DevOps CI/CD Pipelines
End-to-end CI/CD pipelines with automated testing, security checks, and zero-downtime deployments.
...
> I believe great systems are invisible when they work, resilient when they fail, and simple to operate.  
> Build clean. Automate everything. Think long term.
